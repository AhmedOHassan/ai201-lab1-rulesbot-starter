...
```
I didn't expect text to be intentionally duplicated, the 50-character overlap means neighboring chunks share content so a rule split across a boundary isn't lost.
```
